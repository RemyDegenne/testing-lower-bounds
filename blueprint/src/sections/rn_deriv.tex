...
\begin{lemma}
  ...
  Then
  \begin{align*}
  \left( (x,y) \mapsto \frac{d(\kappa \circ \mu)}{d(\kappa \circ \nu)}(y) \right)
  &= (\nu \otimes \kappa)\left[ (x, y) \mapsto \frac{d \mu}{d \nu}(x) \Big| \mathcal B \right]
  \: .
  \end{align*}
...
\begin{proof}%\leanok
\uses{}
It suffices to show that the function is $\mathcal B$-measurable and that for all measurable sets $t$ of $\mathcal Y$,
\begin{align*}
\int_{p \in \mathcal X \times t} \frac{d(\kappa \circ \mu)}{d(\kappa \circ \nu)}(p_2) \partial(\nu \otimes \kappa)
= \int_{p \in \mathcal X \times t} \frac{d \mu}{d \nu}(p_1) \partial(\nu \otimes \kappa)
\: .
\end{align*}

TODO: measurability.

We show that equality. Let $\pi_X : \mathcal X \times \mathcal Y \to \mathcal X$ and $\pi_Y : \mathcal X \times \mathcal Y \to \mathcal Y$ be the projections $\pi_X(x,y) = x$ and $\pi_Y(x,y) = y$.
\begin{align*}
\int_{p \in \mathcal X \times t} \frac{d(\kappa \circ \mu)}{d(\kappa \circ \nu)}(p_2) \partial(\nu \otimes \kappa)
&= \int_{p \in \mathcal X \times t} \frac{d(\kappa \circ \mu)}{d(\kappa \circ \nu)}(\pi_Y(p)) \partial(\nu \otimes \kappa)
\\
&= \int_{y \in t} \frac{d(\kappa \circ \mu)}{d(\kappa \circ \nu)}(y) \partial(\pi_{Y*}(\nu \otimes \kappa))
\\
&= \int_{y \in t} \frac{d(\kappa \circ \mu)}{d(\kappa \circ \nu)}(y) \partial(\kappa \circ \nu)
\\
&= (\kappa \circ \mu)(t)
\: .
\end{align*}
\begin{align*}
\int_{p \in \mathcal X \times t} \frac{d \mu}{d \nu}(p_1) \partial(\nu \otimes \kappa)
&= \int_{x \in \mathcal X} \int_{y \in t} \frac{d \mu}{d \nu}(x) \partial\kappa(x) \partial\nu
\\
&= \int_{x \in \mathcal X} \frac{d \mu}{d \nu}(x) \kappa(x)(t) \partial\nu
\\
&= \int_{x \in \mathcal X} \kappa(x)(t) \partial\mu
\\
&= (\kappa \circ \mu)(t)
\: .
\end{align*}
