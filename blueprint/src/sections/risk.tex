...
\\
&= swap \circ (\hat{y} \parallel \mathrm{id}) \circ (\mathrm{id} \times P_\pi^\dagger) \circ (P \circ \pi)
\\
&= swap \circ (\hat{y} \parallel \mathrm{id}) \circ \left((P \circ \pi) \otimes P_\pi^\dagger\right)
\\
&= swap \circ (\hat{y} \parallel \mathrm{id}) \circ \left(\pi \otimes P\right)
\\
&= (\mathrm{id} \parallel \hat{y}) \circ \left(\pi \otimes P\right)
\\
