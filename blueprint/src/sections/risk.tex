...
\begin{lemma}
  ...
  \lean{ProbabilityTheory.bayesianRisk_eq_bayesInv_prod}
  \leanok
...
\begin{lemma}
  ...
  \lean{ProbabilityTheory.bayesRisk_of_isGenBayesEstimator}
  \leanok
...
\begin{theorem}
  ...
  \lean{ProbabilityTheory.bayesBinaryRisk_eq_integral_min, ProbabilityTheory.toReal_bayesBinaryRisk_eq_integral_min}
  \leanok
  \uses{def:bayesBinaryRisk}
