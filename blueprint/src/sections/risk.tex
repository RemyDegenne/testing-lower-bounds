...
\begin{definition}[Risk]
  ...
  The risk of an estimator $\hat{y}$ on the estimation problem $(P, y, \ell')$ at $\theta \in \Theta$ is $r_\theta(\hat{y}) = \hat{\mu}_\theta\left[z \mapsto \ell'(y(\theta), z)\right]$~.
\end{definition}
...
\begin{definition}[Bayesian risk]
  ...
  \leanok
  \uses{def:risk}
  The Bayesian risk of an estimator $\hat{y}$ on $(P, y, \ell')$ for a prior $\pi \in \mathcal M(\Theta)$ is $R_\pi(\hat{y}) = \pi\left[\theta \mapsto r_\theta(\hat{y})\right]$~.
\end{definition}
...
\begin{definition}[Bayes risk]
  ...
  The Bayes risk of $(P, y, \ell')$ for prior $\pi \in \mathcal M(\Theta)$ is $\mathcal R_\pi = \inf_{\hat{y} : \mathcal X \rightsquigarrow \mathcal Z} R_\pi(\hat{y})$~, where the infimum is over Markov kernels.

  The Bayes risk of $(P, y, \ell')$ is $\mathcal R^*_B = \sup_{\pi \in \mathcal P(\Theta)} \mathcal R_\pi \: .$
\end{definition}
...
\begin{theorem}[Data-processing inequality]
  ...
  \leanok
  \uses{def:bayesRisk}
  For $P : \Theta \rightsquigarrow \mathcal X$ and $\kappa : \mathcal X \rightsquigarrow \mathcal X'$ a Markov kernel, the risk $\mathcal R_\pi$ of $(\kappa \circ P, y, \ell')$ is larger than $\mathcal R_\pi$ for $(P, y, \ell')$.
\end{theorem}
...
&\ge \inf_{\hat{y} : \mathcal X \rightsquigarrow \mathcal Z} \pi\left[\theta \mapsto (\hat{y} \circ P)(\theta)\left[z \mapsto \ell'(y(\theta), z)\right]\right]
\: .
\end{align*}
...
\begin{definition}[Minimax risk]
  ...
  \leanok
  \uses{def:risk}
  The minimax risk of $(P, y, \ell')$ is $\mathcal R^* = \inf_{\hat{y} : \mathcal X \rightsquigarrow \mathcal Z} \sup_{\theta \in \Theta} r_\theta(\hat{y})$~.
\end{definition}
