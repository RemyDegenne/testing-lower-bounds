...
TODO: check if non-probability measures work with our $E_\gamma$ definition.
$E_\gamma$ could be extended to finite measures in two ways: by the risk definition of by the f-divergence definition. Those two don't give the same extension.
...
TODO: the above ignores the non-integral part of divergences and should be fixed.
\end{proof}
