...
TODO: replace the definition by $D(\mu \otimes \kappa, \mu \otimes \eta)$, which allows for more a general proof of the ``conditioning increases divergence'' inequality.
...
\begin{proof}%\leanok
\uses{thm:data_proc_statInfo, thm:statInfo_eq_integral}
...
\begin{proof}%\leanok
\uses{thm:fDiv_eq_integral_eGamma, thm:data_proc_eGamma}
