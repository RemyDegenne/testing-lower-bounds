...
\section{Comparisons between divergences}

Specific divergences are discussed in the next chapters. This section contains general tools that can be used to compare $D_f$ and $D_g$ for two functions $f$ and $g$.
