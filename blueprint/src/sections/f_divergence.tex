...
\begin{lemma}
  ...
  $D_f(\mu_1 + \mu_2, \nu) \le D_f(\mu_1, \nu) + \mu_2(\mathcal X) f'(\infty)$.
\end{lemma}
TODO: the hypothesis $\mu_2 \ll \nu$ should be removable.
...
\begin{lemma}
  ...
  \lean{ProbabilityTheory.toReal_rnDeriv_trim_of_ac}
  \leanok
  %\uses{}
...
\begin{proof}\leanok
\uses{lem:fDiv_trim_le_of_ac, lem:fdiv_add_measure_le_of_ac, lem:fDiv_absolutelyContinuous_add_mutuallySingular}
