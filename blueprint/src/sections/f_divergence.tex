...
\begin{corollary}
  ...
  \lean{ProbabilityTheory.fDiv_prod_right}
  \leanok
  \uses{def:fDiv}
...
\begin{proof}\leanok
\uses{thm:fDiv_compProd_right_1, thm:fDiv_map_le}
...
We can use the DPI for that function (Theorem~\ref{thm:fDiv_map_le}), then Lemma~\ref{thm:fDiv_compProd_right_1},
\begin{align*}
D_f(\kappa \circ \mu, \kappa \circ \nu)
