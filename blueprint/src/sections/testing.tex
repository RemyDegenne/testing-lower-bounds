...
In a sequence of estimation tasks $(P^{\otimes n}, y, \ell')$ for $n \in \mathbb{N}$, the sample complexity is the minimal $n$ such that the risk (Bayes risk, minimax risk...) for the kernel $P^{\otimes n}$ is less than a desired value.
