...
\begin{lemma}
  \label{lem:integral_rpow_rnDeriv_symm}
  \lean{ProbabilityTheory.integral_rpow_rnDeriv_symm}
  \leanok
  \uses{}
...
\begin{proof}\leanok
\uses{lem:integral_rpow_rnDeriv_symm}
Use Lemma~\ref{lem:integral_rpow_rnDeriv_symm}.
\end{proof}
